...
import com.x.session.impl.SessionClient;
import com.x.session.impl.SessionListenerAdaptor;
...
public final class CustomBackedSessionMappingStorage implements SessionMappingStorage {
	...
	private final static ICacheClient jedis = MCSClientFactory.getCacheClient("com.bonc.sso");
