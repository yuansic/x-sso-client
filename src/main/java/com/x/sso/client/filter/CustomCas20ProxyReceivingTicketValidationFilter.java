...
public class CustomCas20ProxyReceivingTicketValidationFilter extends AbstractTicketValidationFilter {
    ...
    protected final TicketValidator getTicketValidator(final FilterConfig filterConfig) {
        ...
        final CustomCas20ServiceTicketValidator validator;

        if (CommonUtils.isNotBlank(allowAnyProxy) || CommonUtils.isNotBlank(allowedProxyChains)) {
            final CustomCas20ProxyTicketValidator v = createNewTicketValidator(ticketValidatorClass, casServerUrlPrefix,
                    CustomCas20ProxyTicketValidator.class);
            ...
            validator = createNewTicketValidator(ticketValidatorClass, casServerUrlPrefix,
                    CustomCas20ServiceTicketValidator.class);
        }
