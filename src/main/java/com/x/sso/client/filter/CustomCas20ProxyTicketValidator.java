 ...
 * @since 3.1
 */
public class CustomCas20ProxyTicketValidator extends CustomCas20ServiceTicketValidator {
    ...
    public CustomCas20ProxyTicketValidator(final String casServerUrlPrefix) {
