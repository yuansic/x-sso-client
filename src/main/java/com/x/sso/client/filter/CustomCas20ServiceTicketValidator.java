...
import static org.jasig.cas.client.util.CommonUtils.closeQuietly;
...
public class CustomCas20ServiceTicketValidator extends AbstractUrlBasedTicketValidator {
    ...
    protected String retrieveResponseFromServer(URL validationUrl, String ticket) {
        ...
        try {
            conn = getURLConnectionFactory().buildHttpURLConnection(validationUrl.openConnection());
            conn.setRequestProperty("Accept","text/html");
            conn.setRequestProperty("Accept-Charset",getEncoding());
